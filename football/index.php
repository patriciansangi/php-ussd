    ...
    <body>
        ...
        <main class="py-4">
            <div class="container">
                ...
                <h1>Football match (Uganda Cranes Vs. Harampe Stars)</h1>
                <hr>
                    ...
                    <?php
                      ...
                      foreach ($records as $key => $value) {
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 col-xl-6">
                            ...
                            <a href="pay_ticket.php?ticket_id=<?php echo $id ?>" class="btn btn-success">Pay Ticket</a>
                ...
                <?php 
                   ...
                   $paymentRecords = $dbConnection->query("SELECT payments.name as customer_name, phone_number,ticket.name as ticket_name, payments.price as amount, payments.id as transaction_id,status FROM payments,ticket WHERE payments.plan_id = ticket.ticket_id"); 
